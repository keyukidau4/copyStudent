        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.course.update',$course->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="{{old('name',$course->name)}}"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" cols="30" rows="10" value="{{old('description',$course->description)}}"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="begin_time" placeholder="{{old('begin_time',$course->begin_time)}}" required />
                </div>

                <div class="form-group">
                    <label for="end_time">終わり時間：</label>
                    <input type="number" class="form-control" name="end_time" placeholder="{{old('end_time',$course->end_time)}}" required />
                </div>
